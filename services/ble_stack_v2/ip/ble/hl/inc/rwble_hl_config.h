...
#define CFG_NB_PRF (BLE_APP_OTA + BLE_APP_GFPS  + BLE_VOICEPATH + BLE_BMS + \
    ...
    BLE_OT_CLIENT + BLE_CSIS_COORD + BLE_CSIS_MEMBER + BLE_HID_DEVICE + BLE_BATT_SERVER + BLE_DIS_SERVER + \
    BLE_APP_WATCH_SERVER + BLE_APP_WATCH_CLIENT + BLE_ADAPTER_PROFILES_NUM + BLE_ADAPTER_CLIENT_NUM)
