 ...
 ****************************************************************************************
 */
#ifndef _ITF_CO_UTILS_H_
#define _ITF_CO_UTILS_H_

/**
 ****************************************************************************************
 * @defgroup ITF_CO_UTILS Utilities
 * @ingroup COMMON
...
#include "itf_co_bt.h"        // common bt definitions
#include "itf_rwip_config.h"  // SW configuration
#include "itf_rwip.h"         // SW configuration
