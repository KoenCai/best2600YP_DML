...
#include "itf_rwapp_config.h"     // Audio Mode 0 configuration
#include "os_api.h"
#include "cmsis.h"
...
#if (BLE_EMB_PRESENT)
#include "itf_rwble_config.h"   // ble stack configuration
#endif //BLE_EMB_PRESENT

#if (BLE_HOST_PRESENT)
#include "itf_rwble_hl_config.h"  // ble Host stack configuration
#endif //BLE_HOST_PRESENT

#if defined(CFG_APP)
#include "itf_rwapp_config.h"     // Application configuration
...
#ifdef __MUTLI_POINT_AI__/// Kernel Message Heap
#define RWIP_HEAP_MSG_SIZE         2 * (  BT_HEAP_MSG_SIZE_      + \
                                      BLE_HEAP_MSG_SIZE_     + \
                                      BLEHL_HEAP_MSG_SIZE_      )

/// Size of Environment heap
#define RWIP_HEAP_ENV_SIZE         2 * ( BT_HEAP_ENV_SIZE_       + \
                                     BLE_HEAP_ENV_SIZE_      + \
