...
const struct gatt_att_desc datapathps_att_db[DATAPATHPS_IDX_NB] =
{
...
#ifdef CTKD_ENABLE  // let app write ccc to trigger secure connection pairing
    ...
    [DATAPATHPS_IDX_RX_VAL]     =   {datapath_rx_char_val_uuid_128_content, PROP(WR) | PROP(WC) | ATT_UUID(128), DATAPATHPS_MAX_LEN},
 ...
 ****************************************************************************************
 */
static void _con_create_cb(prf_data_t* p_env, uint8_t conidx, const gap_con_param_t* p_con_param)
{
...
static void _con_upd_cb(prf_data_t* p_env, uint8_t conidx, const gap_con_param_t* p_con_param)
{
}
