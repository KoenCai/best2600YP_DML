 ...
 ****************************************************************************************
 */
static uint8_t voice_init(struct prf_task_env* env, uint16_t* start_hdl, 
...
{
    (prf_init_fnct) voice_init,
    voice_destroy,
    voice_create,
    voice_cleanup,
};

AI_GATT_SERVER_TO_ADD(AI_SPEC_COMMON, &voice_itf)
