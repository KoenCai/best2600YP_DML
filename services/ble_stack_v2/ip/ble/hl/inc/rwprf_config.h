...
#else
#if defined(BLE_DATAPATHS_ENABLE)
...
#ifdef BLE_WATCH_ENABLE
#define CFG_PRF_WATCH_SERVER
#define CFG_PRF_WATCH_CLIENT
#endif
/**
 ****************************************************************************************
...
#if defined(__DUAL_MIC_RECORDING__)
...
/// WATCH Profile Server Role
#if defined(CFG_PRF_WATCH_SERVER)
#define BLE_WATCH_SERVER     1
#else
#define BLE_WATCH_SERVER     0
#endif // defined(CFG_PRF_DATAPATH_SERVER)

/// WATCH Profile Client Role
#if defined(CFG_PRF_WATCH_CLIENT)
#define BLE_WATCH_CLIENT          1
#else
#define BLE_WATCH_CLIENT          0
#endif // defined(CFG_PRF_WATCH_CLIENT)
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_TILE || BLE_CSIS_COORD || BLE_OT_CLIENT || BLE_MESH || BLE_WATCH_SERVER || BLE_WATCH_CLIENT || BLE_ADAPTER_SERVER_CLIENT)
...
#if (BLE_ISO_MODE_0_PROFILE || BLE_WPT_SERVER || BLE_WPT_CLIENT || defined(BISTO_ENABLED))
...
enum rwprf_id
{
    ...
    #if (BLE_WATCH_SERVER)
    PRF_ID_WATCHPS,
    #endif //(BLE_WATCH_SERVER)

    #if (BLE_WATCH_CLIENT)
    PRF_ID_WATCHPC,
    #endif //(BLE_WATCH_CLIENT)
