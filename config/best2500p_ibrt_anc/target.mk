...
export FREEMAN_FOR_EP ?= 0
ifeq ($(FREEMAN_FOR_EP),1)
KBUILD_CPPFLAGS += -D__FREEMAN_FOR_EP__
endif
...
SYSTEM_FREQ_208M ?= 208
#SKYWALKER_CALL_SYSFREQ_208M ?= 208
#SKYWALKER_MUSIC_SYSFREQ_208M ?= 147

export CP_CPU_USAGE_INTVL_MS ?= 10000
...
#### skywalker specific macro
export SKYWALKER_IMPLEMENTATION ?= 0
ifeq ($(SKYWALKER_IMPLEMENTATION),1)
KBUILD_CPPFLAGS += -DSKYWALKER_IMPLEMENTATION
endif
