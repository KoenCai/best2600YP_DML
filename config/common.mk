...
ifeq ($(CHIP_HAS_CP),1)
ifeq ($(CORE0_RUN_CP_TASK),1)
ifneq ($(KERNEL),RTX5)
$(error Only RTX5 support CORE0_RUN_CP_TASK now)
endif
KBUILD_CPPFLAGS += -DCORE0_RUN_CP_TASK
endif
endif

ifeq ($(BECO_CP_TEST),1)
KBUILD_CPPFLAGS += -DBECO_CP_TEST
endif
...
KBUILD_CPPFLAGS += -DDCDC_HIGH_EFFICIENCY_CTRL
endif
...
export A2DP_AAC_PLC_ENABLED ?= 0
ifneq ($(A2DP_SBC_PLC_ENABLED)-$(A2DP_AAC_PLC_ENABLED),0-0)
KBUILD_CPPFLAGS += -DSKYWALKER_IMPLEMENTATION_PLC
endif
...
export CP_CPU_USAGE_INTVL_MS ?= 0

export SYSTEM_FREQ_208M ?= 208
ifneq ($(filter 122 147 172 208,$(SYSTEM_FREQ_208M)),)
KBUILD_CPPFLAGS += -DSYSTEM_FREQ_208M=$(SYSTEM_FREQ_208M)
else
$(error ERROR: Invalid SYSTEM_FREQ_208M($(SYSTEM_FREQ_208M)))
endif

ifneq ($(filter 122 147 172 208,$(SKYWALKER_CALL_SYSFREQ_208M)),)
export SKYWALKER_CALL_SYSFREQ_208M
endif

ifneq ($(filter 122 147 172 208,$(SKYWALKER_MUSIC_SYSFREQ_208M)),)
export SKYWALKER_MUSIC_SYSFREQ_208M
endif
...
KBUILD_CPPFLAGS += -DBES_BLE_ACTIVITY_MAX=6
...
# generate random value used for workaround rpa address & roleswitch reconnect flag
ifeq ($(BLE_V2),1)
ifeq ($(BLE_USE_RPA),1)
export BLE_RPA_OTA_WORKROUND := 1
KBUILD_CPPFLAGS += -DBLE_RPA_OTA_WORKROUND
endif
endif
endif
endif
