...
{
    /// Manufacturer Name
    [DISC_MANUFACTURER_NAME_CHAR] = {ATT_CHAR_MANUF_NAME,  PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// Model Number String
    [DISC_MODEL_NB_STR_CHAR]      = {ATT_CHAR_MODEL_NB,    PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// Serial Number String
    [DISC_SERIAL_NB_STR_CHAR]     = {ATT_CHAR_SERIAL_NB,   PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// Hardware Revision String
    [DISC_HARD_REV_STR_CHAR]      = {ATT_CHAR_HW_REV,      PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// Firmware Revision String
    [DISC_FIRM_REV_STR_CHAR]      = {ATT_CHAR_FW_REV,      PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// TSoftware Revision String
    [DISC_SW_REV_STR_CHAR]        = {ATT_CHAR_SW_REV,      PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// System ID
    [DISC_SYSTEM_ID_CHAR]         = {ATT_CHAR_SYS_ID,      PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// IEEE
    [DISC_IEEE_CHAR]              = {ATT_CHAR_IEEE_CERTIF, PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
    /// PnP ID
    [DISC_PNP_ID_CHAR]            = {ATT_CHAR_PNP_ID,      PRF_ATT_REQ_PRES_OPT, ATT_CHAR_PROP_RD},
};
                                   ...
                                   ke_task_id_t const src_id)
{
    ...
    PRF_ENV_T(disc) *disc_env = PRF_ENV_GET(DISC, disc);
