 ...
 ****************************************************************************************
 */
#ifndef _ITF_CO_BUF_H_
#define _ITF_CO_BUF_H_

/**
 ****************************************************************************************
 * @defgroup ITF_CO_BUF Utilities
 * @ingroup COMMON
...
#include "itf_co_list.h"      // List manipulation
#include "itf_co_utils.h"     // Bit Field manipulation
